# Myrient DDL - Script de Instalación Automática
# Este script descarga la aplicación desde Google Drive y la instala

param(
    [string]$InstallPath = "$env:LOCALAPPDATA\Myrient DDL",
...
# Carpeta temporal
$TempPath = Join-Path $env:TEMP "MyrientDDL_Install_$(Get-Random)"
$ZipFile = Join-Path $TempPath "myrient-ddl-complete.zip"

Write-Header "Instalador de Myrient DDL"
...
if ($DbArchive) {
    $AppResourcePath = Join-Path $env:LOCALAPPDATA "Myrient DDL" "resources"
...
Write-Status "La aplicación Myrient DDL ha sido instalada correctamente." "Success"
Write-Host ""
